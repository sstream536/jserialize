...
need rapidjson, only include jserialize.hpp
...
```
{
	"age": 27,
	"money": 60000,
	"weight": 80.01000213623047,
	"height": 176.24,
	"man": true,
	"name": "Tom",
	"hobby": ["c++", "game", "football"]
}
...
{
	"number": "ClassRoom_123",
	"teacher": {
		"age": 27,
		"money": 60000,
		"weight": 80.01000213623047,
...
## reference
avplayer community json serialization
